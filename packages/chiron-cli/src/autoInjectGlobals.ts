...
global.__CHIRON_RULE_CSS__ = 'css_rule';
global.__CHIRON_RULE_3RD_CSS__ = 'css_3rd_rule';
global.__CHIRON_RULE_LESS__ = 'less_rule';
global.__CHIRON_RULE_3RD_LESS__ = 'less_3rd_rule';
...
global.__CHIRON_PLUGIN_CSS_MINIFY__ = 'css_minify_plugin';
